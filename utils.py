...
def check_balance(account, token='slp'):
    ...
    w3 = Web3(Web3.HTTPProvider('https://api.roninchain.com/rpc', request_kwargs={"headers": headers}))
    ctr = w3.eth.contract(
...
def get_nonce(account):
    ...
    w3 = Web3(Web3.HTTPProvider('https://proxy.roninchain.com/free-gas-rpc', request_kwargs={"headers": headers}))
